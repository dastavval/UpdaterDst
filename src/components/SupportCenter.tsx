...
export default function SupportCenter({ theme = 'light' }: { theme?: 'light' | 'dark' }) {
  ...
  const contactOptions = [
    ...
    },
    {
      ...
      icon: <Send className="text-emerald-500 rotate-180" size={18} />,
      bgColor: "bg-sky-50 text-emerald-600",
    },
    {
  ...
  return (
    <div className="space-y-10 py-4 text-right" dir="rtl">
      ...
      <section className="relative rounded-[2.5rem] bg-gradient-to-br from-indigo-950 via-indigo-900 to-slate-950 border border-indigo-800/30 p-6 sm:p-10 overflow-hidden shadow-2xl text-white">
        <div className="absolute top-[-30%] left-[-20%] w-[70%] h-[70%] bg-emerald-500/10 rounded-full blur-[140px] pointer-events-none animate-pulse" />
        
        <div className="flex flex-col md:flex-row justify-between items-center gap-6 relative z-10">
          <div className="space-y-4 max-w-2xl">
            <div className="inline-flex items-center gap-2 bg-indigo-550/30 border border-emerald-500/35 px-4 py-1.5 rounded-full text-indigo-300 text-[10px] font-black uppercase tracking-wider">
          ...
          <div className="bg-white/80 backdrop-blur-xl border border-slate-200/80 rounded-[2rem] p-6 shadow-xl space-y-6">
            ...
            <div className="pt-4 border-t border-slate-100 space-y-3 text-[11px] text-slate-500 font-bold">
              ...
              <div className="flex items-center gap-2">
                ...
                <span>تبریز، برج تجارت جهانی، طبقه ۱۲</span>
              </div>
            </div>
          </div>
        </div>
            ...
            <form onSubmit={handleTicketSubmit} className="mt-6 space-y-4">
              <AnimatePresence mode="wait">
                ...
                {submitStatus === 'error' && (
                  <motion.div
                    ...
                    animate={{ opacity: 1, height: "auto" }}
                    exit={{ opacity: 0, height: 0 }}
                    className="p-4 bg-emerald-50 border border-emerald-100 rounded-2xl text-rose-800 text-xs font-bold flex items-center gap-2"
                  >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-slate-50 border border-slate-100 rounded-xl text-xs font-bold outline-none focus:border-emerald-500 focus:bg-white transition-all text-right"
                  />
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-slate-50 border border-slate-100 rounded-xl text-xs font-bold outline-none focus:border-emerald-500 focus:bg-white transition-all text-left"
                    dir="ltr"
                  />
                </div>
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <select
                  ...
                  className="w-full px-4 py-3 bg-slate-50 border border-slate-100 rounded-xl text-xs font-black outline-none focus:border-emerald-500 focus:bg-white transition-all text-right cursor-pointer"
                >
              ...
              <div className="space-y-1.5">
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 bg-slate-50 border border-slate-100 rounded-xl text-xs font-bold outline-none focus:border-emerald-500 focus:bg-white transition-all text-right resize-none"
                />
              </div>

              {formError && (
                <div className="p-3 bg-emerald-50 border border-emerald-100 rounded-xl text-emerald-700 text-[11px] font-black leading-relaxed">
                  {formError}
                </div>
              )}
              ...
              <button
                ...
                className="w-full py-3.5 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl text-xs font-black transition-all shadow-md flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50"
              >
      ...
      <section className="bg-white/80 backdrop-blur-xl border border-slate-200/80 rounded-[2.5rem] p-6 sm:p-10 shadow-xl space-y-6">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 border-b border-slate-100 pb-4">
          <div className="space-y-1">
            <div className="inline-flex items-center gap-1.5 bg-emerald-50 border border-emerald-100 px-3 py-1 rounded-full text-[10px] font-black text-emerald-600">
              <HelpCircle size={14} />
