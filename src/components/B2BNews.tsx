...
const NEWS_DATA: NewsItem[] = [
  {
    ...
    summary: "با سرمایه‌گذاری بخش خصوصی، فاز جدید خط تولید اسنک با ظرفیت روزانه ۴۰ تن به بهره‌برداری رسید. این خط قابلیت بسته‌بندی حجمی با تزریق گاز نیتروژن خلوص بالا را داراست.",
