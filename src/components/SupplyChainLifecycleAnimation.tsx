    ...
    <div className="relative w-full bg-white border border-slate-200/90 rounded-2xl p-3.5 sm:p-5 shadow-xs select-none text-right transition-all" dir="rtl">
      ...
      <div className="flex flex-wrap items-center justify-between gap-2.5 pb-3 mb-3.5 border-b border-slate-100">
        ...
        <div className="flex items-center gap-1.5 shrink-0 mr-auto sm:mr-0">
          {/* Tab Switcher: Commercial Flow vs Profit Calculator */}
          <div className="flex items-center gap-1 bg-slate-100 p-1 rounded-xl text-[10px] font-bold">
            <button
              type="button"
              onClick={() => setActiveTab('flow')}
              className={`px-2.5 py-1 rounded-lg transition-all cursor-pointer flex items-center gap-1 ${
                activeTab === 'flow' ? 'bg-white text-emerald-950 font-black shadow-2xs' : 'text-slate-600 hover:text-slate-900'
              }`}
            >
            ...
            <button
              ...
              className={`px-2.5 py-1 rounded-lg transition-all cursor-pointer flex items-center gap-1 ${
                activeTab === 'calculator' ? 'bg-white text-emerald-950 font-black shadow-2xs' : 'text-slate-600 hover:text-slate-900'
              }`}
            >
              <Banknote size={12} className="text-teal-600" />
              <span>محاسبه‌گر سود بنکدار</span>
            </button>
          </div>
