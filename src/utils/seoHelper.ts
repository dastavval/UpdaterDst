...
export const SEO_TAB_CONFIGS: Record<string, SEOMetadata> = {
  presentation: {
    title: "دست اول | سامانه سراسری خرید عمده مواد غذایی و استعلام مستقیم از کارخانه",
    ...
    schema: {
      ...
      "description": "سامانه سراسری خرید عمده، استعلام مستقیم و تالار کف بازار صنایع غذایی"
    }
  },
  order: {
  ...
  about: {
    title: "درباره سامانه دست اول | پلتفرم مبادلات B2B صنایع غذایی",
    description: "آشنایی با اهداف، ضمانت‌های تجاری، مجوزهای قانونی و تیم پشتیبانی پلتفرم دست اول برای حذف واسطه‌ها و اتصال مستقیم تولید به مصرف.",
    keywords: [
      "درباره دست اول",
